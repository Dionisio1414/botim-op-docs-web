    ...
    <div class="flex flex-1">
      ...
      <Teleport to="body">
        ...
        <Transition name="slide">
          <aside
            v-if="isSidebarOpen"
            class="fixed inset-y-0 left-0 z-50 w-64 overflow-y-auto border-r border-(--ui-border) bg-(--ui-bg) px-2 shadow-xl lg:hidden"
          >
            <div class="flex h-14 items-center justify-between px-3">
              <span class="text-sm font-semibold text-(--ui-text-highlighted)">Admin</span>
              <UButton
                icon="i-lucide-x"
                color="neutral"
                variant="ghost"
